...
\textcolor{red}{XXX add first stage thrust variation? ... maybe if i think its worth it}
...
\textcolor{red}{I should potentially change lift instead of drag here, or change to 10\% (the small effect of drag is pretty useful to know..)}
\begin{table}[ht]
	\centering
	\begin{tabular}{l c c c c c c} 
