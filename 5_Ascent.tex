...
\end{figure}
 ...
 The efficiency of the first stage is increased to \firstExergyEffStandardNoReturn\%$\eta$ due to the increased acceleration \textcolor{red}{that this reduced throttling affords}, an overall improvement of \textcolor{red}{+0.623\%$\eta$ (+10.0\%)} compared to the first stage separating the scramjet accelerator at 50kPa conditions. 
 During the maximum payload-to-orbit trajectory, the first stage rocket releases the scramjet accelerator at a velocity of \firstsecondSeparationvStandardNoReturn m/s, an increase of \textcolor{red}{5.7}\% compared to the first stage releasing the scramjet accelerator onto a constant dynamic pressure trajectory.
...
The reduced time that the rocket must spend in a high dynamic pressure environment, and the decrease in the maximum dynamic pressure that the rocket stage experiences, may allow the structural mass and heat shielding necessary to achieve exoatmospheric flight to be decreased, and may enable higher payload to orbit. \textcolor{red}{Section \ref{sec:TPSredesign} explores the possible improvement in payload-to-orbit via a reduction in the heat shield mass, reduced in proportion to the temperature reduction of the third stage heat shield when flying a payload-to-orbit optimised trajectory, compared to a constant dynamic pressure trajectory. The heat shield reduced with its mass reduced in this way weighs 49.1kg, and leads to an improvement in payload-to-orbit of 15.4kg (11.7\%) when compared to a heat shield weighing the standard amount (124.6kg). In addition, releasing the rocket at lower dynamic pressure reduces the thrust vector angle significantly, to below 1$^\circ$, compared to the angles of close to 7$^\circ$ reached during ascent after release from a scramjet accelerator flying at constant dynamic pressure. These reduced thrust vector angles would likely improve the controllability of the third stage rocket considerably, although detailed investigation of the controllability of the third stage rocket is beyond the scope of this study.} 
...
\textcolor{red}{XXX I need to state that these linear regression sensitivity indicators are just for an approximate indication of sensitivity, and that some sensitivities may be non linear.}
...
\begin{table}[ht]
	...
	\begin{tabular}{l c c c c c c} % updated 30/12/19
