...
\end{figure}
When the fly-back of the scramjet accelerator is included in the trajectory optimisation, the shape of the ascent trajectory of the launch system is \textcolor{red}{not} altered significantly when compared to the ascent-only trajectory, detailed in Chapter \ref{chapter:Ascent}.
