...
\afterpage{
	\begin{landscape}% Landscape page
		...
		\begin{xltabular}{\linewidth}{|X|X|X|}
			...
			& \small
			\textbf{Trajetory:} No detailed trajectory information is readily available. 
			\\
