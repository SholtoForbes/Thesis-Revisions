...
\textcolor{red}{XXX I need to be clear when I am looking at pull-ups that these were limited by the designs, and that this study wants to investigate an optimised trajectory without this. Tie this together with later discussion on my calculated pull-up and how it relates to previous optimal pull-ups. Differentiate between an optimised pull-up, and a hard limited pull-up}

\textcolor{red}{XXX I should frame this section better from the start, give more context in this intro section (which must be changed anyway). I should give more details on why I am focussing on particular aspects of the trajectories, and relate the things that I look at in this section to the work that I've done eg why am I looking at optimal control and exergy analysis.}
...
\textcolor{red}{XXX Combine this with airbreathing access to space systems section. Make each section a more in depth review of single or multi stage launchers, and include their trajectories with them. I should strongly make the point that a well comprehensive study and optimisation of the mission of a multi stage launch system is missing.}
...
https://www.jstage.jst.go.jp/article/tjsass/60/5/60_T-15-71/_pdf/-char/ja}
