...
\textcolor{red}{
This section covers the literature available in the areas that are key to developing and analysing the trajectory for a rocket-scramjet-rocket launch system. Firstly, the need for trajectory modelling and analysis is examined in the context of the launch vehicle design process. 
Then a background of the process of designing and flying access to space systems is given, to supply the reader with a context for the current work in the process of airbreathing launch system development. 
A study is conducted on the airbreathing launch systems that have previously been designed and analysed, along with an analysis of the trajectories of these launch systems that may offer valuable insights into the operations of rocket-scramjet-rocket launch systems. Of particular interest are the trajectories of airbreathing launch systems that have previously been optimised to maximise a performance target, that give insights into the trajectory features that arise from the unique nature of airbreathing launch systems. 
...
\begin{xltabular}{\linewidth}{|X|X|X|}
	...
	\textcolor{red}{XXX No banking during ascent? possible useful..  change to https://www.jstage.jst.go.jp/article/tjsass/60/5/60_T-15-71/_pdf/-char/ja (NOTE: 2DOF no return)? end text of p 272 in interesting}
	&\small
...
Quicksat was designed by SpaceWorks Engineering and the Air Force Research Lab as a conceptual exploration of combined cycle propulsion systems for reusable space access. Quicksat was developed in support of a U.S. military initiative to investigate responsive space access for national security purposes. Quicksat is capable of both the orbital delivery of a Space Manoeuvre Vehicle, as well as hypersonic strike. 
	...
	\textcolor{red}{XXX Need to put in reusable or not}
	\\
\hline 
\end{xltabular} 
\end{landscape}
...
TSTO systems may be designed to be fully or partially reusable, ie. while the booster stage returns to launch site, the orbiter stage may be returned, or discarded. Returning the orbiter stage is a more complex task than returning the booster stage, due to its high velocities, as well as generally being a much smaller vehicle, meaning that the relative mass penalties for including the systems necessary for reuse are more severe. 
Despite this, most of the TSTO launch systems that have been designed are fully reusable, with winged orbiter stages designed for self-landing.
% XXX point out whether each system is reusable
% XXX Specifically point out the starsaber here?
...
% XXX I think i should start this more positively 'three stage systems have recently been advpocated, paricularly by UQ'
...
% XXX Maybe expand this a bit

\subsubsection{The SPARTAN - Design}

%\textcolor{red}{XXX make note of vertical launch}

 The SPARTAN launch system system is considered in this study as a representative model for three stage, rocket-scramjet-rocket access to space system designs. 
 Access to the detailed design of the SPARTAN has been provided by the University of Queensland, where this work has been undertaken. % XXX maybe rephrase this, this work has been performed at uq where the spartan is being designed?
 ...
 The scramjet accelerator stage of the SPARTAN was first designed by Jazra, Preller and Smart\cite{Jazra2010, Jazra2013}, based on the winged-cone vehicle developed by Shaughnessy et al. as part of the NASP program\cite{Shaughnessy1990}. % XXX More details here, powered by c-rest engines developed at UQ etc.
  The scramjet stage in this work is a modified version of the Baseline scramjet accelerator stage designed by Preller \& Smart\cite{Preller2018a,Preller2017b}, defined as The SPARTAN by Preller, although the nomenclature has since been changed so that The SPARTAN refers to the entire launch system. % XXX This sentence is a little unclear
...
It is eventually intended that the first stage of The SPARTAN be returnable to launch site under cruise-back power for reuse, however, a first stage capable of return flight has not been designed or modelled for a full scale SPARTAN system. % XXX double Check this
 Some preliminary work has been carried out, exploring the reuse of the first stage boosters of The SPARTAN \cite{chai2017} for a modified, reduced size SPARTAN concept, however this work is still in its infancy. 
 This work will build on the design of the SPARTAN by designing a non-reusable first stage rocket, to align with the work that has previously been completed\cite{Preller2017b}. % XXX awkward sentence

% XXX some more detail, 'the third stage has been designed and simulated.. stored either in front, within fuselage, or on top 
...
\textcolor{red}{
	% XXX expand with somthing like 'there is no well defined control law to follow, trajectory is highly dependent on starting altitude - maybe expand on this?'
...
% XXX Need to expand on this a bit, cite some books and define optimal control
...
% XXX I should summarise this section - maybe pointing out that it many of these solvers are similar, and most have been used in aerospace applications and may be appropriate to the problem being solved
...
% XXX strt this with something like these optimisation programs require input of dynamic simulations
...
A survey into CFD solvers was conducted, and the specifics of Cart3D, which is utilised in this study, were detailed. 