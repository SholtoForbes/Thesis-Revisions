...
\textcolor{red}{XXX I need to add that it is an oblate earth}
\textcolor{red}{XXX I also need to ad the modificaitons to the first stage}
...
\begin{table}[ht]
	...
	\begin{tabular}{|c|c|c|}
		...
		\hline State Variables & Altitude (z) & 0 - 30km\\ & Speed (v) & 10 - 3000m/s\\ & Trajectory Angle ($\gamma$)& $-5.7^\circ$ - $89.9^\circ$ \\   & Latitude ($\phi$) & $\pm28.6^\circ$ \\  & Longitude ($\xi$)& $114.6^\circ$ - $171.9^\circ$\\   & Heading Angle ($\zeta$)& $\pm360^\circ$\\  & Total Mass (m)& 11453 - 29388kg \\  & Angle of Attack ($\alpha$)&  $-5^\circ$ - 0$^\circ$\\  & $\dot{\alpha}$& $\pm5.7^\circ/s$\\ 
		\hline 
	\end{tabular} 
...
\afterpage{
	\begin{landscape}% Landscape page
		\begin{figure}[ht]
			...
			\caption{\textcolor{red}{XXX Change 6DOF in this image! also check section no.s}The process of the rocket-scramjet-rocket trajectory optimisation. Relevant sections are indicated in square brackets at each process step.}
