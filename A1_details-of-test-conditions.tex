...
\begin{landscape}
	...
	\hline Point & Material & Thermal Conductivity & Specific Heat & Density (kg/m$^3$) & Geometry & Boundary Conditions \\ 
	\hline Scramjet Accelerator Point \textcolor{red}{1} & Tungsten & 237  & 134 & 19250 & 100mm diameter, 40mm thick hemispherical tip & Outer: Stagnation \newline Inner: Adiabatic \\ 
	\hline Scramjet Accelerator Point \textcolor{red}{2} & Carbon-Carbon  & 3.55 & 1829 & 1593 & 11.3mm thick, conical (modelled as cylindrical) on nose, flat on body  & Outer: Swept Leading Edge \newline Inner: Adiabatic  \\ 
	\hline Scramjet Accelerator Points \textcolor{red}{3-6} & Carbon-Carbon  & 3.55 & 1829 & 1593 & 11.3mm thick, conical (modelled as cylindrical) on nose, flat on body  & Outer: Reynolds Analogy \newline Inner: Adiabatic  \\ 
	\hline Third Stage Point \textcolor{red}{1} & Tungsten & 237  & 134 & 19250 & 142mm diameter, 20mm thick hemispherical tip &  Outer: Stagnation \newline Inner: Adiabatic \\ 
	\hline Third Stage Point \textcolor{red}{2} & Carbon-Carbon & 3.55 & 1829 & 1593 & 10.8mm thick, conical (modelled as cylindrical) & Outer: Reynolds Analogy \newline Inner: Adiabatic  \\ 
	\hline Third Stage Point \textcolor{red}{3} & Phenolic Cork & 0.07 & 2100 & 512 & 3.1mm thick, cylindrical  & Outer: Reynolds Analogy \newline Inner: Adiabatic  \\ 
	\hline 
\end{xltabular}
%\caption{Material Properties and Boundary Conditions used for thermal analysis. }
% \label{tab:thermalprops}

\end{landscape}
}

The goal of this analysis is to show that the outside surface temperature does not exceed the temperature limit of the respective material and that the inside temperature is reduced sufficiently so that the external heat shielding material can interface with the internal multi-layer insulation.
...
\caption{The first stage trajectory of the representative launch system flying a maximum payload-to-orbit trajectory, constrained to 50kPa between Mach numbers 6 to 8.}
...
\caption{The scramjet accelerator trajectory of the representative launch system flying a maximum payload-to-orbit trajectory, constrained to 50kPa between Mach numbers 6 to 8.}
...
\caption{The third stage trajectory of the launch system flying a maximum payload-to-orbit trajectory, constrained to 50kPa between Mach numbers 6 to 8.}
...
%\textcolor{red}{XXX Will need to consider redoing this with variation for all stages}
