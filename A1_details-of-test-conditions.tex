...
\section{1-D Thermal Analysis}
 
 
 
To determine the effectiveness of the SPARTAN's TPS system, a 1-D heat analysis is conducted.  %quasi 3d? check this
This heating calculation is implemented through the uqTurbine software package. 
The temperature of the TPS is calculated at various points over the scramjet accelerator and third stage. 
This gives an indication of the temperature at specified points around the SPARTAN throughout its trajectory. 
Figure \ref{fig:TrajTemp} shows the heat responses at the specified locations over the trajectory of The SPARTAN. 
...
-TPS thickness required to get under 1000C

--TPS thermal conductivity / other properties required to get under 1000C

-active cooling efficiency required to get under 1000C
...
This section discusses some of the significant design and modelling factors that are not explicitly addressed in the current work.
