...
%-add 'A Low Subsonic Study of the NASA N2A Hybrid Wing-Body Using an Inviscid Euler-Adjoint Solver' and maybe others? - its too hard to estimate the values from almosnino.. sagerman only gives some specific pressure results, 
