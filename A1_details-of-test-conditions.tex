...
%-add 'A Low Subsonic Study of the NASA N2A Hybrid Wing-Body Using an Inviscid Euler-Adjoint Solver' and maybe others?
...
In the same study used to identify the uncertainties associated with Cart3D, Abeynayake \& Agon assess Missile Datcom at Mach 4.5 for the conventional missile design\cite{Abeynayake2013a}. Missile Datcom was observed to provide reasonable estimates of lift and drag values, with a mean uncertainty values of 17.5\% for drag, and 7.5\% for lift in the supersonic regime. However, Missile Datcom was not observed to provide a good estimate of pitching moment in the supersonic regime, with a 42.5\% mean error. The centre of pressure and associated errors are not stated. 
...
From these experimental comparisons it is evident that Missile Datcom is able to predict normal forces reasonably closely. However, there is variation in the accuracy of predicted pitching moment and centre of pressure locations, and overall Missile Datcom is poor at estimating axial forces. 
...
The uncertainty margins of the aerodynamic and propulsive data for the representative launch system analysed in this study are shown in Table \ref{tab:AppendixUncertainty}. These uncertainty margins have been applied based on the errors described in the studies analysed in the preceding sections adjusted using engineering judgement. As a correction was applied for viscous effects, the uncertainty margins in Cart3D derived drag properties are based heavily on the work by Ward et al.\cite{Ward2018}, though with the magnitude of the uncertainty increased slightly due to the drag uncertainties observed by Abenayake and Agon\cite{Abeynayake2013a}, which are higher than those observed by Ward et al. even accounting for viscous effects.
The subsonic uncertainty in the lift and drag are set to a nominalk value 20\%. This value accounts for reduced uncertainty due to the low angle of attack of the launch system at subsonic speeds, though takes into account the complexity of the representative launch system, which is likely to increase the error in the modelled aerodynamics.

\textcolor{red}{This is an example, I am not sure if it is appropriate to use an estimated value or if I should take a value directly from one of the experimental comparisons.}


\begin{tabular}{|c|c|c|c|}
	\hline  Parameter & Subsonic Uncertainty & Transonic Uncertainty  & Supersonic/Hypersonic Uncertainty \\ 
	\hline  SPARTAN/First Stage $C_L$ & 20\% &  &  \\  
	\hline  SPARTAN/First Stage $C_D$ & 20\% &  &  \\  
	\hline  SPARTAN/First Stage $X_{CP}$ &  &  &   \\ 
	\hline  SPARTAN/First Stage $T$ &  &  &   \\ 
	\hline  Third Stage $C_L$ &  &  &  \\ 
	\hline  Third Stage $C_D$ &  &  &  \\ 
	\hline  Third Stage $X_{CP}$ &  &  &   \\ 
	\hline  Third Stage $T$ &  &  &   \\ 
	\hline 
...
\textcolor{red}{\section{Example - Shuttle Reentry}}
