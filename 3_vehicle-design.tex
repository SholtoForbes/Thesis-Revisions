...
\begin{tabular}{|c|c|c|c|}
	...
	\hline  Tungsten Nose & $\rho_{Tungsten} = 19250$  kg/m$^3$ & 142mm diameter, 20mm thick hemispherical tip & 10.0kg \\ 
...
XXX make this just a small mention at the start
	...
	%*/ as part of the conclusion you should also consider discussing methodology you have applied. I.e. an additional contribution of this chapter is providing a process of how to develop mass and aerodynamics data for a launch systems. This is valuable for anyone wanting to design their own launch vehicle. So you should highlight this as one of the contributions from this part of your thesis.
	
	%*/ Overall, have a look at the chapter narrative. There are a few sections that are repeated. This then creates confusion, as it is not clear which approach is used to perform a certain part of the analysis. - need to have a look through section for this
