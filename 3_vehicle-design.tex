...
\end{figure}
		...
		\begin{figure}[ht]
			...
			\end{subfigure}
			\caption{The aerodynamic coefficients of the SPARTAN with the C-REST engines powered-on. Coefficients correspond to a reference area of 62.77m$^2$ and a centre of gravity of 15.23m (full of fuel, with third stage).}
...
\begin{figure}[ht]
	...
	\begin{subfigure}{.5\textwidth}
		...
		\label{fig:LD}
	\end{subfigure}
	\caption{Aerodynamic Characteristics of the SPARTAN with C-REST engine powered-off. Coefficients correspond to a reference area of 62.77m$^2$ and a centre of gravity of 14.23m (no third stage, conical tank full).}
	\label{fig:aero1}
\end{figure}
