...
\textcolor{red}{XXX I need to make it clear that this design is building on and changing the existing design of the spartan, and that it is intended to be used as a representative launch system. I should clearly define the scope, and level to which I am designing the launch system.}

\textcolor{red}{XXX I also need to make it clear why stage separations are not modelled: This is because they act as mostly a hard constraint to the trajectory, and would limit the knowledge gained from an optimised trajectory. In addition, there is a large amount of design to be done on the separation mechanism, which is likely to require a broad study with high fidelity modelling (maybe put this before, dont use as excuse). }
...
\textcolor{red}{XXX I should be specific about the program used to calculate the CRESTM10 database}
...
The thrust and specific impulse of the Merlin 1-C are determined by interpolation between the sea level and vacuum specific impulse of the Merlin 1-C, shown in Table \ref{tab:1stStageEngine}, with ambient pressure. Thrust scaling is determined by linear pressure scaling using nozzle exit area, $T = T_{SL} + (p_e - p_{SL})A_e$. 
 The Merlin 1-C is throttled down to a constant 70\%, \textcolor{red}{the minimum throttlable level of the Merlin 1-C \cite{Norris2011}}, a throttling value determined during the trajectory optimisation process to allow the first stage to pitch over more easily, while still allowing the first stage rocket to accelerate the SPARTAN to Mach 5 \textcolor{red}{XXX This sentence is not good, change it}.
  ...
  \textcolor{red}{XXX Do viscous for first stage stack, or make clear why I havent.}
...
\end{figure}
	...
	\textcolor{red}{The design of the third stage rocket in this study is modified significantly from the third stage rocket designed for the Baseline SPARTAN configuration\cite{Preller2017b}.}
	In this study the third stage rocket is designed to accommodate a SpaceX Kestrel engine, whereas in previous studies the third stage was designed to be powered by a Pratt \& Whitney RL-10-3A pump-fed engine. The Kestrel has been used over the RL-10-3A for its cost effectiveness. As a pressure-fed engine, the Kestrel trades off specific impulse for cost savings when compared to the RL-10-3A. Because the only expendable portion of the system is projected to be the third stage, the cost of the third stage will be one of the main drivers of overall system cost. Reducing the cost of the third stage allows the cost of launch to be directly reduced. 
	
	\textcolor{red}{The transition to the Kestrel engine from the Rl-10-3A changes the propellant of the third stage from LOX/LH2 to LOX/RP-1. 
		The oxidiser-to-fuel mixture ratio of RP-1 is lower than that of LH2, 2.56\cite{RPE} compared to 6\cite{Preller2017b}, and the density of RP-1 is significantly higher than that of LH2, 813kg/m$^3$\cite{Magee} compared to 70.99kg/m$^3$\cite{Preller2017b}. Due to the significantly higher proportion of higher density fuel, the mass of the third stage rocket will be higher than previous designs for the same internal volume, allowing the size of the fuselage to be reduced. For this reason, the geometry of the third stage rocket has been redesigned for this study.}
	
	\textcolor{red}{The length of the third stage has been reduced to account for the reduced fuel volume necessary. The third stage centrebody length has been reduced to 4.5m, giving a total length of 9m, with a 3m long nose unmodified from the Baseline third stage\cite{Preller2017b} and a 1.5m long engine\cite{Vehicle2008}. An overall length of 9m is chosen so that the third stage is able to fit within the main cylindrical fuselage section of the Baseline SPARTAN geometry, as illustrated in Figure \ref{fig:INTERNALS}. This is advantageous because the third stage in this study is housed within the body of the SPARTAN, necessitating a release mechanism such as retractable panels or a hinged fuselage section. While the release mechanism of the third stage is not considered in this study, it is assumed that the release process will be simplified if the release mechanism is constrained to the cylindrical fuselage of the SPARTAN, rather than involving geometric variation of the nose cone of the SPARTAN, which receives a large amount of aerodynamic force as illustrated in Figure \ref{fig:CartTop}. The diameter of the third stage has been increased to 1.1m including heat shield, an increase of 0.05m compared to the third stage configuration designed for the Baseline SPARTAN\cite{Preller2017b}. This diameter increase matches the diameter of the third stage to the maximum diameter of the kestrel nozzle for consistency in width. } 
	
	The third stage rocket is released at the end of the scramjet accelerator burn, and lifts the payload out of the atmosphere and into the desired orbit. The third stage weighs a total of 3300kg. This has been chosen as a nominal design weight, to satisfy the fuel necessary to achieve orbit with an acceptable payload, while also allowing for ample payload volume. The internal layout of the third stage rocket is shown in Figure \ref{fig:3rdStage}. The third stage has a structural mass fraction of \textcolor{red}{0.079}, similar to the Falcon 1 second stage \textcolor{red}{without the Kestrel engine or fairing included}\cite{Vehicle2008}. This gives a total structural mass of \textcolor{red}{236.3kg, without heat shield or engine, and assuming a payload mass of 100kg}. 
	
The kestrel engine which powers the third stage is modified to have 50\% increased propellant mass flow rate, giving a mass flow rate of 14.8kg/s. This is done to assist the rocket in exiting the atmosphere, as it was found during analysis that a the third stage has difficulty exiting the atmosphere when powered by a standard Kestrel engine. \textcolor{red}{A 50\% increase in mass flow rate provides additional thrust such that the trajectory angle of the third stage does not decrease after release from the SPARTAN flying a constant dynamic pressure trajectory. This was chosen as the indicative factor that the third stage is successfully able to pull-up out of the atmosphere.} It is likely that this mass flow increase will necessitate a heavier combustion chamber \textcolor{red}{as well as more heavy duty piping and valves, more or larger injectors, and a heavier nozzle and structure to transmit the higher thrust forces\cite{RPE,Huzel1967}. To compensate for these factors, the mass of the Kestrel is increased by 50\%, from 52kg\cite{Wade2017} to 78kg, encompassing the thrust chamber as well as all feed systems, cooling systems, and the gymballing system of the rocket motor. This is estimated to be slightly conservative, as the surface area of the combustion chamber, and thus the mass and the cooling necessary, will not vary linearly with the increase in volume necessary to maintain a constant characteristic length as mass flow rate in increased\cite{RPE,Huzel1967}. However, as the mass of the relative components of the Kestrel are not published, a conservative approach to mass increase is appropriate. The need to modify the Kestrel engine for this study highlights the potential necessity for the design of a cheap rocket engine with higher thrust than the Kestrel, Aestus or OMS.}
...
The medium and low fidelity modelling techniques used in this work have been chosen for their fitness-for-purpose for optimal trajectory analysis. 
\begin{tabular}{|c|c|}
	\hline Source of Uncertainty & Estimated Error  \\ 
	\hline  Aerodynamic Modelling & \\ 
	\hline  Aerodynamic Modelling< Mach 2 &  \\ 
	\hline  Viscous Effects - Control Surfaces &  \\ 
	\hline  &  \\ 
	\hline 
\end{tabular} 
}
