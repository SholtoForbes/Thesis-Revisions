...
\textcolor{red}{This work aims to study the optimised trajectory and performance of a rocket-scramjet-rocket launch system. In order to produce this trajectory, the launch system must be modelled in some detail.
...
\end{figure}
 ...
 This launch system weighs a total of \textcolor{red}{28,355}kg, and is 32.44m long. 
...
% This is an empirical equation that uses free stream conditions for some reason.. mc (which I think is mass spillage) and Acap are both variable and empirical, and are related to the cross-shock properties.  
%\begin{equation} 
...
analyse hypersonic vehicles, and has shown fair agreement with experimental data across multiple studies\cite{Abeynayake2013a,Ward2018,Kiris2011}, as described in Appendix \textcolor{red}{\ref{sec:aerounc}}.
...
\begin{tabular}{|c|c|c|c|}
	...
	\hline 
\end{tabular} 
\caption{Third stage heat shield properties.} % updated 12/8/19
...
\end{table}
	...
	The propulsion system for the third stage rocket in previous studies has been modelled after the RL-10-3A\cite{Preller2018a}. However, the Rl-10-3A is expensive, and for the expendable upper stage of a small launch system a cheap engine will be required, as the cost of this engine will have a large bearing on the cost efficiency of the launch system as a whole. The following section outlines the redesign of the third stage rocket, so that it is more cost effective, and uses a more modern engine.  
		...
		\subsubsection{Exoatmospheric Rocket Engine Survey}%moved from lit review%\textcolor{red}{XXX I should potentially use the kestrels use of RP1 as a justification too, non exremely toxic?}
		...
		\subsubsection{Kestrel Propulsion System Modelling}
			\textcolor{red}{
...
\textcolor{red}{
\section{Modelling and Design Simplifications}\label{sec:simpl}  % XXX this is one for ingo to look at in particular, the location of this and how it fits in + discussion on controlinstability + section on aero and propulsion
}
